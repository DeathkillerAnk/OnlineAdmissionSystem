...
<html>
    ...
    <body>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><br><br><img src="./images/logov.jpg" width="50%"> </td>
                ...
                <center><font style="font-family:Arial Black; font-size:20px;">
                    ADMISSION YEAR 2019-20</font></center>
                </td>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="3"> <?php echo 'Mobile Number - '. $row[2]. '   ' ?><br>
                    <?php echo ' Alternate Mobile number - '.$row[3] ?></td>
                  </tr>
