        ...
        <form id="adform" action="admsnform.php" method="post">
            ...
            <table class="frmtbl">
                ...
                <tr border="1" class="hdrow">
                  ...
                  <tr>
                          <td> <font style="font-family: Verdana;"><h4>Welcome in VJTI, <?php echo $stname;?></h4> </font> </td>
                    <td colspan="2"> 
                  ...
                  <tr>
                    ...
                    <td colspan="3"> <input type="text" id="uphn1" name="uphn1" placeholder="Mobile number" required="true" VT="PH">
                    <input type="text" id="uphn2" name="uphn2" placeholder="Alternate Mobile Number" required="true" VT="PH"></td>
                  </tr>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="cadr" name="cadr" class="ad"placeholder="Address" style="margin-top: 4px;" required="true"><br>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="padr" name="padr" class="ad" placeholder="Address" style="margin-top: 4px;"required="true"><br>
                ...
                <tr>
                    <td> <font style="font-family: Verdana;">Residance Type</font>
                ...
                <tr>
                    <td> <font style="font-family: Verdana;">Caste</font>
                    <td colspan="5">
                        <input type="radio" id="cat" name="cat" value="GEN"><font style="font-family: Verdana;">GENERAL</font>
                        <input type="radio" id="cat" name="cat" value="OBC"><font style="font-family: Verdana;">OBC</font>
                        <input type="radio" id="cat" name="cat" value="SC"><font style="font-family: Verdana;">SC</font>
                        <input type="radio" id="cat" name="cat" value="ST"><font style="font-family: Verdana;">ST</font>
                        <input type="radio" id="cat" name="cat" value="NT"><font style="font-family: Verdana;">NT</font>
                 ...
                 <tr>
                    <td><font style="font-family: Verdana;">Selection Criteria</font></td>
                    <td><select id="oaco" name="oaco" required="true">
                            <option>--------------------Select--------------------</option>
                            <option>CET</option>
                            <option>Diploma 3rd year exam</option>
                       ...
                       <table class="table table-hover">
                           ...
                           <tr>
                               ...
                               <td colspan="3">
                                    ...
                                    <input type="radio" id="moi" name="moi" value="Marathi"><font style="font-family: Verdana;">Marathi</font>
                                    ...
                                    <input type="radio" id="moi" name="moi" value="Urdu"><font style="font-family: Verdana;">Urdu</font>
                           ...
                           <tr>
                               ...
                               <td colspan="3">
                                    <input type="radio" id="pay" name="pay" value="Onl"><font style="font-family: Verdana;">Online</font>
                                    <input type="radio" id="pay" name="pay" value="DD"><font style="font-family: Verdana;">Demand Draft</font>
                               </td>
                           </tr>
